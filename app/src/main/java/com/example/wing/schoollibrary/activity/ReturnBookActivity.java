...
import com.example.wing.schoollibrary.adapter.ReturnBookAdapter;
...
public class ReturnBookActivity extends Activity {
    ...
    private void getDataFromNet() {
        if(checkForLogin()){
            ...
            OkHttpUtils.get(Urls.URL_RETURNBOOK)
...
//            startActivity(new Intent(this,LoginActivity.class));
            startActivityForResult(new Intent(this,LoginActivity.class),LoginActivity.REQUEST_RETURNBOOK_CODE);
            return false;
        }
    }
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode==LoginActivity.REQUEST_RETURNBOOK_CODE&&resultCode!=RESULT_CANCELED&&
